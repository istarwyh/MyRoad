...
### 3.4. Hadoop云盘
#### 3.4.1. JAVA_HOME is not defined correctly.
**输入**
`ant -version`
**返回**
```bash
...
#### 3.4.5. java.lang.NullPointerException
**点击**
`java build path`
**解决**
更换了IDE
#### 3.4.6. An internal error occurred during: "Map/Reduce location status updater
### 3.5. 各种安装问题
#### 3.5.1. python安装
##### 3.5.1.1. `ERROR: scipy-1.4.1-cp39-cp39-win_amd64.whl is not a supported wheel on this platform.`
版本不对，可能是因为少了一个`m`
